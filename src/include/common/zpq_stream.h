 ...
 */
extern ZpqStream  *zpq_create(int c_alg_impl, int c_level, int d_alg_impl);
 ...
 */
extern ssize_t		zpq_write(ZpqStream * zs, void const *buf, size_t size, size_t *processed, void *dst, size_t dst_size, size_t *dst_processed);
