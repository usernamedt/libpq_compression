...
static ssize_t zstd_end(void *c_stream, void *dst, size_t dst_size, size_t *dst_processed) {
    ZPQ_ZSTD_CStream *cs = (ZPQ_ZSTD_CStream *) c_stream;
...
static ssize_t zlib_end(void *c_stream, void *dst, size_t dst_size, size_t *dst_processed) {
    z_stream   *cs = (z_stream *) c_stream;
    int			rc;
...
static ssize_t zpq_init_compressor(ZStream *zs, int c_alg_impl, int c_level) {
...
static ssize_t zpq_init_decompressor(ZStream *zs, int d_alg_impl) {
